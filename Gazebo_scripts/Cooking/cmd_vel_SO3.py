...
class ustar_m:
    ...
    def target_track_stir(self, count, p_t, q_t, fp_t, w_t, xref, xref_vel, scaler_t, control_t, point):
        ...
        xref_ind = jnp.where(is_ind_limit, chosen_ind, 28)
    ...
    def compute_ustar_m(self, count, p_t, q_t, fp_t, w_t, control_t, control_t_p, change_flag, trans_period, beta_t,
        ...
        return vel_cmd_final_cmd[0], vel_cmd_final_cmd[1], vel_cmd_final_cmd[2], vel_cmd_final_cmd[3], vel_cmd_final_cmd[4], vel_cmd_final_cmd[5], beta_t, change_flag, vel_cmd_final_cmd, u1
...
def main():
    ...
    while not rospy.is_shutdown():
        ...
        # if close_to_end and control_t_ours<2:
        #     count_switch += 1
        #     if count_switch > 3:
        #         control_t_ours = jnp.minimum(control_t_ours+1, 2)
        #         count_switch = 0
        ...
        f1x, f1y, f1z, f1x_rot, f1y_rot, f1z_rot, beta_t, change_flag, vel_cmd_prevs, u1 = ustar_obj.compute_ustar_m(count, xt, qt, fxt, fxt_rot, 
