...
pub_dirt_size = rospy.Publisher('/my_aut_plan/dirt_size', Vector3, queue_size=10)
...
def pub_dirt_size_fn(dirt_size_x, dirt_size_y, dirt_size_z):
    dirt_size_vector = Vector3()
    
    dirt_size_vector.x = dirt_size_x
    dirt_size_vector.y = dirt_size_y
    dirt_size_vector.z = dirt_size_z

    pub_dirt_size.publish(dirt_size_vector)
...
def main():
    ...
    while not rospy.is_shutdown():
        ...
        if stain_count == 0:
            ...
            pub_dirt_size_fn(h_w[0], h_w[1], h_w[2])
        ...
        if control_prop_t == 2 or control_prop_t == 3:
            ...
            pub_dirt_size_fn(aut_dec_obj.dirt_size[0], aut_dec_obj.dirt_size[1], 
                            aut_dec_obj.dirt_size[2])
