...
def main():
    ...
    data_files = ['trajectory_data_legs.npy',
                  'trajectory_data_hands.npy',
                  'trajectory_data_back.npy']
    data_files_orig = ['trajectory_data_legs_orig.npy',
                       'trajectory_data_hands_orig.npy',
                       'trajectory_data_back_orig.npy']
    model_files = ['/config/wiping_legs.eqx',
                   '/config/wiping_hands.eqx',
                   '/config/wiping_back.eqx']
    ...
    for i in range(n_DS):
        ...
        xref_orig = model_load(ts_new, traj_load[0, :])
        xref = xref_orig[start_ind:end_ind]
    ...
    ## Initialize node
    freq = 500
    rospy.init_node('NODE_model', anonymous=True)
