...
class my_visualisation:
    def __init__(self):
        ...
        ## Subscribe to dirt and dip position, control_t
        ...
        # rospy.Subscriber('/tkinter/control_t', Int32, self.control_t_callback, queue_size=1, tcp_nodelay=True)
        # rospy.Subscriber('/control_t_ours', Int32, self.control_t_callback, queue_size=1, tcp_nodelay=True)
...
def main():
    ...
    data_files_orig = ['trajectory_data_scooping.npy',
    ...
    rospy.init_node('my_visuals_SO3', anonymous=True)
    ...
    while not rospy.is_shutdown():
        ...
        if visualize_obj.control_t == 0 or visualize_obj.control_t == 3:
            marker.color.a = 0.0
        ...
        elif visualize_obj.control_t == 2 or visualize_obj.control_t == 4:
            marker.color.a = 0.0
        ...
        #     marker.color.a = 0.0
        #     visualize_obj.publish_data_path.publish(markerArray_data[3])
        #     visualize_obj.publish_ref_path.publish(markerArray_ref[3])
        rate.sleep()
